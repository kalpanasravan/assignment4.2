package com.example.mahathi.assignment42.adapters;
...
/**
 * Created by new user on 30-03-2017.
 *
 * Custom adapter to inflate the layout
 */
...
public class CustomAdapter extends BaseAdapter  {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.description.setText(data.get(position).getPhneNo());
        return convertView;
    }
